...
import it.uniroma3.siw.myprojectsiw02.repository.UserRepository;
...
public class UserService {
    ...
    public boolean canReview(User user, Book book){
        for (Review review : user.getReviews()) {
            if(review.getreviewedBook().equals(book)) return false;
        }
        return true;
    }
    @Transactional
